...
function createDOMNodes(page) {
    ...
    currentArray.forEach((result) => {
        ...
        // Copyright
        const copyrightResult = result.copyrght === undefined ? '' : result.copyrght;
        const copyrght = document.createElement('span');
        copyrght.textContent = ` ${copyrightResult}`;

        // Append
        footer.append(date, copyrght);
